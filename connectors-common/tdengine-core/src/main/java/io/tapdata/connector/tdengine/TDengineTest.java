...
public class TDengineTest extends CommonDbTest {
    ...
    public TDengineTest(TDengineConfig postgresConfig) {
        super(postgresConfig);
        jdbcContext = DataSourcePool.getJdbcContext(postgresConfig, TDengineJdbcContext.class, uuid);
    }
    ...
    public TestItem testLogPlugin() {
        try {
            ...
            testSqls.add(String.format(PG_LOG_PLUGIN_CREATE_TEST, ((TDengineConfig) commonDbConfig).getLogPluginName()));
